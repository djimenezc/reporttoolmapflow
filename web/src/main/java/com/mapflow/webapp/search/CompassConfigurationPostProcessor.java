...
public class CompassConfigurationPostProcessor implements LocalCompassBeanPostProcessor {
  ...
  @Override
  public void process(final CompassConfiguration config) throws ConfigurationException {
    ...
    final String rootPackage = classPackage.substring(0, classPackage.indexOf("webapp") - 1);
