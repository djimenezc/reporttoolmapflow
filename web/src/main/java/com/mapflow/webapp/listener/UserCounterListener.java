...
public class UserCounterListener implements ServletContextListener, HttpSessionAttributeListener {
  ...
  /**
   * Needed for Acegi Security 1.0, as it adds an anonymous user to the session and then replaces it
   * after authentication. http://forum.springframework.org/showthread.php?p=63593
   * 
   * @param event
   *          the session binding event
